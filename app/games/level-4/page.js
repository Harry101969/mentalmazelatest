...
export default function Level4Page() {
  ...
  const progressValue = activities.length > 0 ? (completedActivities.length / activities.length) * 100 : 0;
                      ...
                      <div className="p-4 bg-muted/50 rounded-lg">
                        <div className="text-2xl font-bold text-green-600">
                          {completedActivities.length > 0 ?
                            Math.round(completedActivities.reduce((acc, activity) => acc + activity.score, 0) / completedActivities.length) : 0}%
                        </div>
                        <div className="text-sm text-muted-foreground">Mindfulness Score</div>
                      </div>
                    </div>
