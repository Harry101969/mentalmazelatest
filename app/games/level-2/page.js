...
//   // Default breathing pattern (4-4-4-4) in case getBreathingPattern is not available
...
//   useEffect(() => {
//     // Get a random breathing pattern for this session or use default
//     try {
//       const pattern = getBreathingPattern('beginner', 60, 'general');
//       setSelectedPattern(pattern || defaultPattern);
//     } catch (error) {
...
//                     }}
//                     transition={{
//                       duration: selectedPattern ? selectedPattern.pattern[breathingPhase] / 1000 : 4,
//                       ease: "easeInOut"
//                     }}
//                   />
...
export default function Level2Page() {
  ...
  // Default breathing pattern (4-4-4-4) in case getBreathingPattern is not available
  const defaultPattern = {
    pattern: { inhale: 4000, hold: 4000, exhale: 4000, pause: 4000 }
  };
  ...
  const progressValue = Math.max(0, Math.min(100, ((60 - timeRemaining) / 60) * 100));
