...
// // // export default function DashboardPage() {
// // //   // Initialize with mock data to prevent build errors
...
// // //     {
// // //       mood: 6,
// // //       notes: "Okay day, some stress from work.",
// // //       date: new Date(Date.now() - 172800000).toISOString() // 2 days ago
// // //     },
// // //     {
// // //       mood: 7,
// // //       notes: "Good mood after exercise.",
...
// // //       if (response.ok) {
// // //         const data = await response.json();
// // //         setStats(data.stats || stats); // Fallback to mock data
// // //         setRecentMoods(data.recentMoods || recentMoods); // Fallback to mock data
// // //       } else {
// // //         // If API doesn't exist or returns error, keep using mock data
// // //         console.log('API not available, using mock data');
// // //       }
// // //     } catch (error) {
// // //       console.log('API endpoint not available yet, using mock data');
// // //       // Keep the mock data, don't throw error
// // //     } finally {
// // //       setLoading(false);
// // //     }
// // //   };
...
// // //                 <CardContent className="p-4 text-center">
// // //                   <Zap className="h-8 w-8 text-purple-500 mx-auto mb-2" />
// // //                   <div className="text-2xl font-bold">{user?.tokens || 150}</div>
// // //                   <div className="text-sm text-slate-600 dark:text-slate-400">Tokens Earned</div>
// // //                 </CardContent>
// // //               </Card>
// // //             </div>
...
// // //                   {(user?.subscription === 'free' || !user?.subscription) && (stats?.levelsCompleted || 0) >= 3 && (
// // //                     <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-700">
// // //                       <div className="flex items-center justify-between">
// // //                         <div>
// // //                           <h4 className="font-semibold">Unlock Premium Levels</h4>
...
// // import { Avatar, AvatarFallback, AvatarImage } from '@/components/ui/avatar';
// // import UserNavbar from '@/components/user-navbar';
// // // Mock user data to prevent build errors
// // const mockUser = {
// //   name: 'John Doe',
// //   nickname: 'John',
// //   avatar: '',
...
// //               <div>
// //                 <h1 className="text-4xl font-bold mb-2">
// //                   Welcome back, {mockUser?.nickname || mockUser?.name?.split(' ')[0] || 'Friend'}! 👋
// //                 </h1>
// //                 <p className="text-xl text-slate-600 dark:text-slate-300">
// //                   Let's continue your journey to better mental wellness
// //                 </p>
...
// //                 <CardContent className="p-4 text-center">
// //                   <Zap className="h-8 w-8 text-purple-500 mx-auto mb-2" />
// //                   <div className="text-2xl font-bold">{mockUser?.tokens || 150}</div>
// //                   <div className="text-sm text-slate-600 dark:text-slate-400">Tokens Earned</div>
// //                 </CardContent>
// //               </Card>
// //             </div>
...
// //                   {(mockUser?.subscription === 'free' || !mockUser?.subscription) && (stats?.levelsCompleted || 0) >= 3 && (
// //                     <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-700">
// //                       <div className="flex items-center justify-between">
// //                         <div>
// //                           <h4 className="font-semibold">Unlock Premium Levels</h4>
...
//   const [recentMoods, setRecentMoods] = useState(mockRecentMoods);
//   const [loading, setLoading] = useState(false);
//   const [mounted, setMounted] = useState(false);
...
//         <div className="container mx-auto px-4">
//           {/* Welcome Section */}
//           <div className="mb-12 animate-in fade-in slide-in-from-bottom-4 duration-600">
//             <div className="flex items-center justify-between mb-8 p-6 bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm rounded-2xl border border-blue-100 dark:border-slate-700">
//               <div>
//                 <h1 className="text-4xl font-bold mb-2">
//                   Welcome back, {mockUser?.nickname || mockUser?.name?.split(' ')[0] || 'Friend'}! 👋
...
//           {/* Emergency Support */}
//           <div className="mb-12 animate-in fade-in slide-in-from-bottom-4 duration-600 delay-100">
//             <h2 className="text-2xl font-bold mb-6">Emergency Support</h2>
//             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//               {emergencyFeatures.map((feature, index) => {
//                 const Icon = feature.icon;
...
//           {/* Progress Overview */}
//           <div className="mb-12 animate-in fade-in slide-in-from-bottom-4 duration-600 delay-200">
//             <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border-blue-100 dark:border-slate-700">
//               <CardHeader>
//                 <CardTitle className="flex items-center">
//                   <TrendingUp className="mr-2 h-5 w-5" />
...
//           {/* Quick Actions */}
//           <div className="mb-12 animate-in fade-in slide-in-from-bottom-4 duration-600 delay-300">
//             <h2 className="text-2xl font-bold mb-6">What would you like to do?</h2>
//             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
//               {quickActions.map((action, index) => {
//                 const Icon = action.icon;
...
//             {/* Today's Recommendations */}
//             <div className="animate-in fade-in slide-in-from-right-4 duration-600 delay-500">
//               <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border-blue-100 dark:border-slate-700">
//                 <CardHeader>
//                   <CardTitle className="flex items-center">
//                     <Calendar className="mr-2 h-5 w-5" />
...
// Mock recent moods data
const mockRecentMoods = [
  { mood: 8, notes: "Feeling great today! Had a productive morning.", date: new Date(Date.now() - 86400000).toISOString() },
  { mood: 6, notes: "Okay day, some stress from work.", date: new Date(Date.now() - 172800000).toISOString() },
  { mood: 7, notes: "Good mood after exercise.", date: new Date(Date.now() - 259200000).toISOString() }
];
...
export default function DashboardPage() {
  ...
  const quickActions = [
    { title: 'Continue Game', description: 'Resume your mental wellness journey', icon: GameController2, href: '/games', gradient: 'from-blue-500 to-cyan-500', action: 'Level ' + (stats?.currentLevel || 1) },
    { title: 'AI Buddy Chat', description: 'Talk to your AI companion', icon: MessageCircle, href: '/ai-chat', gradient: 'from-purple-500 to-pink-500', action: 'Chat Now' },
    { title: 'Track Mood', description: 'Log your current emotional state', icon: Heart, href: '/mood-tracker', gradient: 'from-red-500 to-orange-500', action: 'Add Entry' },
    { title: 'Find Therapist', description: 'Connect with professionals', icon: Users, href: '/therapists', gradient: 'from-green-500 to-emerald-500', action: 'Browse' },
    { title: 'Relaxing Music', description: 'Curated playlists for wellness', icon: Music, href: '/music', gradient: 'from-indigo-500 to-blue-500', action: 'Listen' },
    { title: 'Journal', description: 'Reflect on your thoughts', icon: BookOpen, href: '/journal', gradient: 'from-amber-500 to-orange-500', action: 'Write' }
  ];

  const emergencyFeatures = [
    { title: 'Call a Friend', description: 'Instant access to your support network', icon: Phone, href: '/call-friend', color: 'bg-green-600 hover:bg-green-700' },
    { title: 'Crisis Support', description: 'Immediate help when you need it most', icon: Heart, href: '/crisis-support', color: 'bg-red-600 hover:bg-red-700' }
  ];
  ...
  const progressValue = stats && typeof stats.levelsCompleted === 'number' ?
    Math.max(0, Math.min(100, (stats.levelsCompleted / 5) * 100)) : 0;
